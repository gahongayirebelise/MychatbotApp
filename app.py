...
#nltk.download('punkt')
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql+psycopg2://belise:64q8D9QAe0hUj2C5kXETRRn5S64mbhm3@dpg-cf2kahh4reb5o46211rg-a.oregon-postgres.render.com/chatbot_2klu"
db = SQLAlchemy(app)
CORS(app)
## Database
